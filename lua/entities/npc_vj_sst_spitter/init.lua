...
-----------------------------------------------*/
ENT.Model = "models/predatorcz/stbugs/uropygi_tigris_sputare.pmd/model.mdl" -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 550
---------------------------------------------------------------------------------------------------------------------------------------------
