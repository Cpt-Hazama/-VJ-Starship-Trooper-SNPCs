...
-----------------------------------------------*/
ENT.Model = "models/predatorcz/stbugs/uropygi_basilicus.pmd/model.mdl" -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:SST_Initialize()
	self.bodyparts = {
		["6"] = {Hitgroup = {6}, Health = 300, Bodygroup = 10, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_fl.mdl", IsDead = false}, // Right Front Leg
		["16"] = {Hitgroup = {16}, Health = 150, Bodygroup = 11, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_rf2.mdl", IsDead = false}, // Right Front Joint
		["26"] = {Hitgroup = {26}, Health = 100, Bodygroup = 12, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_rf3.mdl", IsDead = false}, // Right Inner Leg
		["7"] = {Hitgroup = {7}, Health = 300, Bodygroup = 7, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_fl.mdl", IsDead = false}, // Left Front Leg
		["17"] = {Hitgroup = {17}, Health = 150, Bodygroup = 8, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_lf2.mdl", IsDead = false}, // Left Front Joint
		["27"] = {Hitgroup = {27}, Health = 100, Bodygroup = 9, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_lf3.mdl", IsDead = false}, // Left Inner Leg
		["3"] = {Hitgroup = {3}, Health = 250, Bodygroup = 4, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_bl.mdl", IsDead = false}, // Left Back Leg
		["13"] = {Hitgroup = {13}, Health = 150, Bodygroup = 5, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_lb2.mdl", IsDead = false}, // Left Back Joint
		["23"] = {Hitgroup = {23}, Health = 100, Bodygroup = 6, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_lb3.mdl", IsDead = false}, // Left Inner Leg
		["2"] = {Hitgroup = {2}, Health = 250, Bodygroup = 1, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_bl.mdl", IsDead = false}, // Right Back Leg
		["12"] = {Hitgroup = {12}, Health = 150, Bodygroup = 2, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_rb2.mdl", IsDead = false}, // Right Back Joint
		["22"] = {Hitgroup = {22}, Health = 100, Bodygroup = 3, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_rb3.mdl", IsDead = false}, // Right Inner Leg
		["4"] = {Hitgroup = {4}, Health = 150, Bodygroup = 14, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_claw2.mdl", IsDead = false}, // Left Claw
		["5"] = {Hitgroup = {5}, Health = 150, Bodygroup = 13, Gib = "models/predatorcz/stbugs/uropygi_basilicus.pmd/g_claw2.mdl", IsDead = false} // Right Claw
	}
...
function ENT:SST_Think()
	if self.VJ_IsBeingControlled && self.VJ_TheController:KeyDown(IN_ATTACK2) && self.MeleeAttacking == false && self.UsingScreamAttack == false then
	...
	if self:GetEnemy() != nil && !self.VJ_IsBeingControlled then
...
function ENT:CheckScreamTrace()
	...
	if self.VJ_IsBeingControlled == false then
		...
		tracedata.endpos = self.VJ_TheControllerBullseye:GetPos()
	end
...
function ENT:SelectHitgroupBehavior(ourvalues,v,dmginfo,hitgroup)
	...
	if ourvalues.Health <= 0 && ourvalues.IsDead == false then
		...
		if hitgroup == 4 || hitgroup == 5 then
			self:CreateVJHitboxGib("models/predatorcz/stbugs/uropygi_basilicus.pmd/g_claw3.mdl",dmginfo:GetDamagePosition() +Vector(0,0,30))
		end
