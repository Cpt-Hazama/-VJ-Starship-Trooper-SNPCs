...
local NAME = "Quad Rocket Launcher"
local MDL = "models/weapons/w_multi_rocket_launcher.mdl"
local HOLD = "rpg"
local CLIP = 1
local FIRERATE = 10
...
if (CLIENT) then return end
	...
	for i = 1,4 do
		...
		if self.Owner:IsPlayer() then SpawnBlaserRod:SetPos(OwnerPos) else SpawnBlaserRod:SetPos(self:GetAttachment(self:LookupAttachment("missile")).Pos +rocketpos[i]) end
